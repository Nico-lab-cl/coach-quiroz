                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <h1 className="text-5xl sm:text-6xl font-bold mb-6">
                                Programa <br />
                                <span className="text-gold-500">Junior Coaching</span>
                            </h1>
                            <p className="text-xl text-gray-300 mb-8 leading-relaxed font-light">
                                La Escuela de Formación Integral para el futuro del tenis. Desarrollamos la técnica, el físico y la mentalidad desde una edad temprana, con un enfoque progresivo y divertido.
                            </p>
                            ...
                            <div className="bg-black-800/50 border border-white/5 rounded-2xl p-6 mb-10">
                                ...
                                <ul className="space-y-4">
                                    <li className="flex items-start gap-4 text-gray-300">
                                        <div className="bg-gold-500/10 p-2 rounded text-gold-500"><i className="fas fa-users"></i></div>
                                        <div>
                                            <strong className="block text-white">Grupos Reducidos</strong>
                                            <span className="text-sm">Máximo 12 alumnos por grupo para asegurar atención.</span>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-4 text-gray-300">
                                        <div className="bg-gold-500/10 p-2 rounded text-gold-500"><i className="fas fa-user-plus"></i></div>
                                        <div>
                                            <strong className="block text-white">Doble Supervisión</strong>
                                            <span className="text-sm">2 entrenadores en cancha simultáneamente.</span>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-4 text-gray-300">
                                        <div className="bg-gold-500/10 p-2 rounded text-gold-500"><i className="fas fa-clock"></i></div>
                                        <div>
                                            <strong className="block text-white">Intensidad Mensual</strong>
                                            <span className="text-sm">8 horas de entrenamiento estructurado al mes.</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="relative group">
                            ...
                            <img src="/images/pack-juniors-optimized.webp" alt="Junior Coaching" className="relative rounded-2xl shadow-2xl w-full h-auto object-cover" />
                        </div>
                    </div>
                </div>
            </section>
