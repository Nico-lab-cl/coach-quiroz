            ...
            <section className="py-24 relative bg-[#000000] border-t border-gold-500/10 overflow-hidden mt-20">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
                    <div className="text-center mb-20 relative">
                        {/* Elite Decorative Line - Adjusted to align with the badge, not the title */}
                        <div className="absolute top-5 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-gold-500/30 to-transparent -z-10"></div>

                        <span className="inline-block bg-black border border-gold-500/30 text-gold-500 text-[10px] font-black tracking-[0.4em] uppercase px-8 py-2.5 rounded-full mb-8 shadow-[0_0_25px_rgba(212,175,55,0.1)]">
                            Sedes y Operaciones
                        </span>
                        
                        <h2 className="text-5xl sm:text-6xl font-light mb-8 tracking-tight text-white leading-tight">
                            Centros de <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-gold-100 via-gold-400 to-gold-600 drop-shadow-[0_2px_10px_rgba(212,175,55,0.2)]">Alto Rendimiento</span>
                        </h2>
                        
                        <p className="text-gray-400 max-w-2xl mx-auto font-light leading-relaxed text-lg italic opacity-90">
                            Infraestructura seleccionada meticulosamente para garantizar la máxima eficiencia, privacidad y enfoque durante tu desarrollo técnico y mental.
                        </p>
                    </div>
